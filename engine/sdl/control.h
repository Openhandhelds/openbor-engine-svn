...
#include "joysticks.h"
	...
	#define 	CONTROL_DEFAULT1_SCREENSHOT	SDL_SCANCODE_0
	#else
	#define 	CONTROL_ESC			SDLK_ESCAPE
	#define 	CONTROL_DEFAULT1_SCREENSHOT	SDLK_0
	#endif
	#define 	CONTROL_DEFAULT1_START		PANDORA_BUTTON_START
	#define 	CONTROL_DEFAULT1_FIRE1		PANDORA_BUTTON_A
	#define 	CONTROL_DEFAULT1_FIRE2		PANDORA_BUTTON_X
	#define 	CONTROL_DEFAULT1_FIRE3		PANDORA_BUTTON_Y
	#define 	CONTROL_DEFAULT1_FIRE4		PANDORA_BUTTON_B
	#define 	CONTROL_DEFAULT1_FIRE5		PANDORA_BUTTON_L1
	#define 	CONTROL_DEFAULT1_FIRE6		PANDORA_BUTTON_R1
	#define 	CONTROL_DEFAULT1_UP		PANDORA_BUTTON_UP
	#define 	CONTROL_DEFAULT1_RIGHT		PANDORA_BUTTON_RIGHT
	#define 	CONTROL_DEFAULT1_DOWN		PANDORA_BUTTON_DOWN
	#define 	CONTROL_DEFAULT1_LEFT		PANDORA_BUTTON_LEFT
#elif GP2X
